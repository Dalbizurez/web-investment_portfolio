    ...
    return (
        ...
        <div className="w-1/4 bg-gray-100 p-4 rounded-l-2xl border-r">
            ...
            <li
                className={`cursor-pointer ${activeTab === "profile" ? "font-bold text-blue-600" : ""}`}
                onClick={() => setActiveTab("profile")}
            >
                Perfil
            </li>
            <li
                className={`cursor-pointer ${activeTab === "password" ? "font-bold text-blue-600" : ""}`}
                onClick={() => setActiveTab("password")}
            >
                Contraseña
            </li>
            <li
                className={`cursor-pointer ${activeTab === "language" ? "font-bold text-blue-600" : ""}`}
